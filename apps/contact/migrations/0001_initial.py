    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.fields.RichTextField(blank=True, help_text='Tekst wprowadzający nad formularzem')),
                ('thank_you_text', wagtail.fields.RichTextField(blank=True, help_text='Tekst wyświetlany po wysłaniu formularza')),
                ...
                ('company_nip', models.CharField(blank=True, max_length=15, verbose_name='NIP')),
                ('map_embed_url', models.URLField(blank=True, help_text='URL do osadzenia mapy Google Maps (iframe src)')),
                ('working_hours', models.TextField(blank=True, help_text="Godziny pracy, np. 'Pon-Pt: 8:00-16:00'")),
            ],
            options={
